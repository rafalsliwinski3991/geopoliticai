...
from geopoliticai.graph import build_runtime_config, get_compiled_graph, run_pipeline
from geopoliticai.models import build_initial_pipeline_state, normalize_language
...
class RunPipelineResponse(BaseModel):
    """Response payload containing the rendered pipeline output."""
...
async def run_pipeline_stream_endpoint(
    ...
    async def _generate() -> AsyncGenerator[str, None]:
        try:
            graph = get_compiled_graph(payload.infosphere)
