...
# Versioned identifier for the curated source allow-lists. Increment whenever
# `ENGLISH_INFOSPHERE_SOURCES` or `POLISH_INFOSPHERE_SOURCES` change so that
# audits and downstream consumers can correlate outputs with a known list.
# See: docs/sources-methodology.md
SOURCES_VERSION = "2026-Q2"
